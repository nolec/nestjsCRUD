...
var _jsxFileName = "C:\\Users\\\uB178\uC2B9\uB798\\Desktop\\nestjs\\nextjs\\components\\Header.js";
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const handleSubmit = async e => {
    ...
    if (!update) {
      const res = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('http://localhost:3000/boards', formData);
    } else {
      const res = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.patch(`http://localhost:3000/boards/${formData.id}`, formData);
  ...
  const deleteBtn = async id => {
    console.log(id);
    const res = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.delete(`http://localhost:3000/boards/${id}`);
    setRender(true);
  };
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    const getAllBoards = async () => {
      const res = await axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('http://localhost:3000/boards');
  ...
  }, boards && boards.length > 0 && boards.map((board, i) => __jsx(Item, {
    key: i,
    __self: undefined,
    __source: {
      fileName: _jsxFileName,
  ...
  }, `글쓴이 : ${board.writer}, 제목 : ${board.title}, 내용 : ${board.contents}`, __jsx("button", {
    type: "button",
...
module.exports = __webpack_require__(/*! C:\Users\노승래\Desktop\nestjs\nextjs\pages\index.js */"./pages/index.js");
